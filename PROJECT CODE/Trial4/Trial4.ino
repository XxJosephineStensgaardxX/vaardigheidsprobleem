...
//}
//
//void MoveForwardInCenter() { //far
//
//  long sideDistance = getDistanceSide();
//  if(sideDistance > 5) {
//    analogWrite(MOTOR_RIGHT_FORWARD, 195);
//    analogWrite(MOTOR_LEFT_FORWARD, 247); //left speed more
//  }
//
//  else if(sideDistance < 5) { //close
//    analogWrite(MOTOR_RIGHT_FORWARD, 195); //right speed more
